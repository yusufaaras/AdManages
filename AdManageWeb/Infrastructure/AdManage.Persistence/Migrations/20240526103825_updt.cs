        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BronzePackagesId = table.Column<int>(type: "int", nullable: true),
                    GoldPackagesId = table.Column<int>(type: "int", nullable: true),
                    SilverPackagesId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {

...
{
    public class DefaultSilverPackagesStrategy : ISilverPackagesStrategy //TODO BEHAVIOURAL- STRATEGY METHOD USAGE 1
    {
        private readonly GetSilverByIdQueryHandler _getSilverByIdQueryHandler;

        public DefaultSilverPackagesStrategy(GetSilverByIdQueryHandler getSilverByIdQueryHandler)
        {
